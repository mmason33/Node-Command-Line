...
function movieThis(){
  ...
  if(!movie){
    ...
    for (var i = 3;i < movie.length; i++) {
        params = params + movie[i] + '+';
    }
  }
  request("http://www.omdbapi.com/?apikey=" + keys.omdbKey + "&t=" + params + "&y=&plot=short&r=json&tomatoes=true", function (error, response, body) {
